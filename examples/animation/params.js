define(["three.min"], 
	...
	*/
	...
	uniforms: {
		uvscale: { type: "f", value: 1, min: 0.5, max: 2, displayName: "UV Scale" },
		color:   { type: "c", value: [255, 255, 255], displayName: "Color" },
		useTexture:   { type: "b", value: true, displayName: "Use Texture" },
	},
	...
	fragmentShader: [
		...
		"	float specular = 0.0;",
		"",
		"	float ut = float(useTexture);",
		"	vec3 albedo = blend(texture2D(texture, texcoord).rgb, color) * ut + color * (1.0-ut);",
		"",
		"	if(lambertian > 0.0) {",
